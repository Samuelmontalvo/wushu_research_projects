...
p2
ggsave(file.path("..", "figures", "mass.png"))
```
...
ggarrange(p1_index,p2_index,ncol = 2)
ggsave(file.path("..", "figures", "NSCA_abstract.png"))
```
...
ggsave(file.path("..", "figures", "inter_coeff.png"))
```
...
ggsave(file.path("..", "figures", "index3predicted.png"))
```
